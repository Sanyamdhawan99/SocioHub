...
<html >
    ...
    <body>
        ...
        <section class="mbr-fullscreen" id="header2-1" style="background-color: #fffde8">
            <div style="position: absolute; width: 218px; height: 577px; z-index: 1; left: 1293px; top: 86px; " id="layer4" class="style11" >
                <br>
