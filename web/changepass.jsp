    ...
    <head>
        ...
        <%
            try {
                ...
                String email = (String) ss.getAttribute("userid");
                String img = (String) ss.getAttribute("userimg");
                String qry = "select Bio, username from tbuser where userid='" + email + "'";
        ...
        <script type="text/javascript">
             function checkPass(){
                ...
                var pass = document.forms["f1"]["p1"].value;
                var url = "passcheck?pass=" + pass;
                xmlhttp.onreadystatechange = function(){
                    if(xmlhttp.readyState == 4 && xmlhttp.status == 200){
                        
                         if(xmlhttp.responseText == "*Incorrect Password") {
            ...
            var check = function () {
                ...
                if (pass1 === pass2) {
                    ...
                    document.getElementById("s2").innerHTML = '*passwords match';
                } else {
                    document.getElementById("s2").style.color = 'red';
                    document.getElementById("s2").innerHTML = '*passwords donot match';
                }
            }
            function disp(){
                var xmlhttp = new XMLHttpRequest();
                var pass = document.forms["f1"]["p1"].value;
                var newpass = document.forms["f1"]["p2"].value;
                var url = "changepass?pass=" + pass + "&newpass=" + newpass;
                alert(url);
                xmlhttp.onreadystatechange = function(){
                    if(xmlhttp.readyState == 4 && xmlhttp.status == 200){
                        
                         if(xmlhttp.responseText === "Error occured!") {
        ...
        <section class="mbr-fullscreen" id="header2-1" style="background-color: #fffde8">
            ...
            <div style="position: absolute; width: 201px; height: 600px; z-index: 1; left: 75px; top: 55px; " id="layer1" class="style10" >
                ...
                <div style="position: absolute; width: 150px; height: 150px; z-index: 1; left: 22px; top: 63px" id="layer2">
                    <a href="viewprof.jsp?id=<%=email%>"> <img src="<%=img%>" width="150" height="150" alt="profile image" style="border-radius: 50%"> </a>
                </div>
                <br><br><br><br><br><br><br><br>
            ...
            <div style="position: absolute; width: 749px; height: 506px; z-index: 1; top: 142px; left: 436px" id="layer4 " class="style9">
                <form method="post" action="" name="f1">
                    <table style="width: 100%; height: 452px">
                        <tr>
                            <td colspan="3" class="style5">CHANGE PASSWORD</td>
                        </tr>
                        <tr>
                            <td class="style7" style="width: 324px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <span class="style6">CURRENT PASSWORD</span></td>
                            <td style="width: 158px" class="style7">
                                <input name="Password1" id="p1" type="password" required onblur="checkPass()"></td>
                            <td id="s1">&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="style7" style="width: 324px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <span class="style6">NEW PASSWORD</span></td>
                            <td style="width: 158px">
                                <input name="Password2" id="p2" type="password" required onkeyup="check();" ></td>
                            <td id="s2">&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="style7" style="width: 324px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style3">
                                </span><span class="style6">CONFIRM PASSWORD</span></td>
                            <td style="width: 158px">
                                <input name="Password3" id="p3" type="password" required onkeyup="check();"></td>
                            <td id="s3">&nbsp;</td>
                        </tr>
                        <tr>
                            <td style="width: 324px">&nbsp;</td>
                            <td style="width: 158px">
                                <input name="Submit1" type="submit" value="UPDATE" onclick="disp();"></td>
                            <td id="s4">&nbsp;</td>
                        </tr>
                    </table>
                </form>
