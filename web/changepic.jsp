...
&nbsp;&nbsp;&nbsp; Bio</span></strong><br>
 ...
 <div style="position: absolute; width: 592px; height: 405px; z-index: 1; top: 142px; left: 436px" id="layer4 " class="style9">
     <form method="post" action="changepic2" enctype="multipart/form-data">
						<table style="width: 100%; height: 339px">
							<tr>
								<td colspan="3" class="style5" style="height: 143px">
								CHANGE PROFILE PIC&nbsp;</td>
							</tr>
							<tr>
								<td class="style7" style="width: 436px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="style11">Choose your profile 
								picture</span></td>
								<td>
                                                                    </td>
								<td>&nbsp;</td>
							...
							<tr>
								<td class="style7" style="width: 436px">
                                                                    <input name="f1" type="file" required="">&nbsp;</td>
								<td>
                                                                    <input name="Submit1" type="submit" value="Upload">&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
						</table>
					</form>
