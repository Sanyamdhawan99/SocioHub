            ...
            <div style="position: absolute; width: 850px; z-index: 2; left: 388px; top: 105px;" id="layer5" class="style11">
                <div style="position: absolute; width: 770px; z-index: 1; left: 36px; top: 45px" id="layer6" class="style13">
                    ...
                    <table style="width: 100%;">
                        <%
                            try {
                                String qry2 = "select username, userid, userimg from tbuser where userid='"+uid+"'";
                                ResultSet rs2 = new Global().execute(qry2);
                                while(rs2.next()) {
                                %>
                                <center>
                                
                                <a href="viewmsg2.jsp?id=<%=rs2.getString("userid")%>"><img src="<%=rs2.getString("userimg")%>" height="150px" width="150px" style="border-radius: 50%"> </a>
                           ...
                           <br>
                                ...
                                qry2 = "select a.msgdesc, a.msgid, a.msgfrmuserid, a.msgtime, a.msgdate, b.userid, b.username from tbmsg a, tbuser b where a.msgtouserid='"+email+"' and a.msgfrmuserid='"+uid+"' and a.msgfrmuserid = b.userid or  msgtouserid='"+uid+"' and msgfrmuserid='"+email+"' and a.msgfrmuserid = b.userid";
                        ...
                        <tr>
                            ...
                            <td>
                                <%=rs2.getString("a.msgdesc")%>
                            </td>
                            <td>
                                <%=rs2.getString("a.msgdate")%>
                            </td>
                            <td>
                                <%=rs2.getString("a.msgtime")%>
                            </td>
                            <td>
                                <button><a href="deletemsg?msgid=<%=rs2.getString("msgid")%>&id=<%=uid%>">Delete</a></button>
                            </td>
                        </tr>
                    ...
                    <br>
                    <center>
                            <form name="f1" action="sendmsg2?fid=<%=uid%>" method="post"">
                           
                                <textarea rows="3" cols="100" name="area1" placeholder="Enter your message here..." required></textarea>
