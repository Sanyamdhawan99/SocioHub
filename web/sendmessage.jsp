            ...
            <div style="position: absolute; width: 850px; z-index: 2; left: 388px; top: 105px;" id="layer5" class="style11">
                ...
                <div style="position: relative; width: 768px; z-index: 2; left: 36px; top: 116px" id="layer7">
                    <table style="width: 100%;">
                        <%
                            try {
                                String qry2 = "select username, userid, userimg from tbuser where userid!='" + email + "'";
                        ...
                        <td>
                            <div class="row">
                                <a href="viewprof2.jsp?id=<%=rs2.getString("userid")%>">    <img src="<%=rs2.getString("userimg")%>" height="150px" width="150px" style="border-radius: 50%"> </a>
                            </div>
                            <div class="row">
                        ...
                        <td>
                            <form name="f1" action="sendmsg?fid=<%=rs2.getString("userid")%>" method="post" onsubmit="checkmsg();">
                            <div class="row">
                                <textarea rows="3" name="area1" placeholder="Enter your message here..." required></textarea>
                            </div>
                            <br>
                            <div class="row">
