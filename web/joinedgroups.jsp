            ...
            <div style="position: absolute; width: 850px; z-index: 2; left: 388px; top: 105px;" id="layer5" class="style11">
                ...
                <div style="position: relative; width: 768px; z-index: 2; left: 36px; top: 116px" id="layer7">
                    <table style="width: 100%;">
                        <%
                            try {
                                String qry2 = "select a.mambergid, b.grpdesc, b.grpowner, b.grpimg, b.groupid, c.username from tbgroupmember a, tbgroup b, tbuser c where memberuserid='"+email+"' and b.groupid = a.mambergid and c.userid = b.grpowner";
                        ...
                        <td>
                            <div class="row">
                                <a href="viewgrp.jsp?id=<%=rs2.getString("b.groupid")%>">    <img src="<%=rs2.getString("b.grpimg")%>" height="150px" width="150px" style="border-radius: 50%"> </a>
                            </div>
                            <div class="row">
                                <%=rs2.getString("b.grpdesc")%>
                            </div>
                            <div class="row">
                                (Owner: <%=rs2.getString("c.username")%>)
                            </div>
