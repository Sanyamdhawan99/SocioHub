...
&nbsp;&nbsp;&nbsp; Bio</span></strong><br>
   ...
   <div style="position: absolute; width: 709px; height: 506px; z-index: 1; top: 142px; left: 375px" id="layer4 " class="style9">
					<form method="post" action="editprof2">
						<table style="width: 108%; height: 452px">
							<tr>
								<td colspan="3" class="style5">EDIT PROFILE</td>
							</tr>
							<tr>
								<td class="style12" style="width: 289px">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style6">USERNAME</span></td>
								<td style="width: 295px">
                                                                    <input name="Text1" type="text" value="<%=rs.getString("username")%>" ></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td class="style12" style="width: 289px">
								...
								<td style="width: 295px">
								<input name="Text2" type="email" value="<%=email%>" readonly ></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td class="style12" style="width: 289px">
								...
								<span class="style6">MOBILE No.</span></td>
                                                                <td style="width: 295px"><input name="Text5" type="num" maxlength="10" minlength="10" value="<%=rs.getString("usermob")%>"  >&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td class="style12" style="width: 289px">
								...
								<td style="width: 295px"><input name="Text6" type="text" value="<%=rs.getString("userqualification")%>" >&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td class="style12" style="width: 289px">
								...
								<td style="width: 295px">
								<textarea name="TextArea1" cols="20" rows="2" ><%=rs.getString("useradd")%></textarea>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td class="style12" style="width: 289px">
								...
								<td style="width: 295px">
								<textarea name="TextArea2" cols="20" rows="2" ><%=rs.getString("userinterest")%></textarea></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								...
								BIO</td>
								<td style="width: 295px">
								<textarea name="TextArea3" cols="20" rows="2"> <%=rs.getString("Bio")%> </textarea>&nbsp;</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td class="style12" style="width: 289px">
								...
								<td style="width: 295px"><input name="Text4" type="date" value="<%=rs.getString("userdob")%>"></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
