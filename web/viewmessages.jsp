            ...
            <div style="position: absolute; width: 850px; z-index: 2; left: 388px; top: 105px;" id="layer5" class="style11">
                ...
                <div style="position: relative; width: 768px; z-index: 2; left: 36px; top: 116px" id="layer7">
                    <table style="width: 100%;">
                        <%
                            try {
                                String qry2 = "select distinct a.username, a.userid, a.userimg from tbuser a, tbmsg b where b.msgtouserid='"+email+"'and b.msgfrmuserid=a.userid";
                        ...
                        <td>
                            <div class="row">
                                <a href="viewmsg2.jsp?id=<%=rs2.getString("a.userid")%>"><img src="<%=rs2.getString("a.userimg")%>" height="150px" width="150px" style="border-radius: 50%"> </a>
                            </div>
                            <div class="row">
                                <%=rs2.getString("a.username")%>
                            </div>
                            <div class="row">
