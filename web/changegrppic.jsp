...
<%
    try {
        ...
        int gid = Integer.parseInt(request.getParameter("id"));
         String qry = "select grpdesc, grpowner, grpimg, grpbio from tbgroup where groupid="+gid;
...
<div style="position: absolute; width: 201px; height: 600px; z-index: 1; left: 75px; top: 55px; background-color: #fffde8" id="layer1" class="style10" >
	...
	<div style="position: absolute; width: 150px; height: 150px; z-index: 1; left: 22px; top: 63px" id="layer2">
            <a href="viewgrp.jsp?id=<%=gid%>"><img src="<%=rs.getString("grpimg")%>" width="150" height="150" alt="profile image" style="border-radius: 50%"></a>
		</div>
		<br><br><br><br><br><br><br><br>
                <strong><span class="style2">&nbsp;&nbsp;&nbsp;<%=rs.getString("grpdesc")%></span></strong>
...
&nbsp;&nbsp;&nbsp; Bio</span></strong><br>
 ...
 <div style="position: absolute; width: 592px; height: 405px; z-index: 1; top: 142px; left: 436px" id="layer4 " class="style9">
     <form method="post" action="grouppic2?id=<%=gid%>" enctype="multipart/form-data">
						<table style="width: 100%; height: 339px">
							...
							<tr>
								...
								<span class="style11">Choose your group
								picture</span></td>
								<td>
                                                                    </td>
								<td>&nbsp;</td>
