...
&nbsp;&nbsp; <a href="viewblog.jsp?id=<%=gid%>">View available blogs</a></div>
            ...
            <div style="position: absolute; width: 592px; height: 405px; z-index: 1; top: 142px; left: 436px" id="layer4 " class="style9">
                <form method="post" action="create?id=<%=gid%>">
                    <table style="width: 100%; height: 321px">
                        <tr>
                            <td class="style17" style="height: 80px">
                                <span class="style2"><span class="style16">&nbsp; <br>
								CREATE BLOG<br>
								</span></span>
								<br>
								&nbsp;
								<textarea name="TextArea1" placeholder="Enter your text here..." style="width: 505px; height: 192px" rows="1" class="style14" cols="20"></textarea><br>
								&nbsp;<br>
								&nbsp;&nbsp;&nbsp;
