    ...
    <head>
        ...
        <script>
         function unfriend(){
            ...
            document.getElementById("isE").innerHTML = "You are no longer friends!";
            ...
            <div style="position: absolute; width: 850px; z-index: 2; left: 388px; top: 105px;" id="layer5" class="style11">
                ...
                <div style="position: relative; width: 768px; z-index: 2; left: 33px; top: 2px; height: 380px;" id="layer7">
                    <table style="width: 100%; height: 309px;">
                        <%
                            try {
                                String qry2 = "select a.sno, a.userid, b.userimg, b.username from tbfriend a, tbuser b where a.fid='" + email + "'and reqstatus=" + 1 + " and a.userid=b.userid";
                        ...
                        <td style="height: 271px">
                            ...
                            <br>
                            <div class="row">
                                <button onclick="unfriend()"><a href="unfriend?fid=<%=rs2.getString("a.userid")%>&sno=<%=rs2.getString("a.sno")%>">UNFRIEND</a></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <%
                            ...
                            %>
                            <br> <br>
                            <div style="color: red"><b>You have no friends right now!</b></div>
                            <%
}
                        %>
