...
<html >
    ...
    <%
        try {
            ...
            String qry = "select username, ifnull(useradd,'')useradd, ifnull(usermob,'')usermob, ifnull(userqualification,'')userqualification, ifnull(userinterest,'')userinterest, ifnull(Bio,'')Bio, ifnull(userdob,'')userdob from tbuser where userid='" + email + "'";
    ...
    <body>
        ...
        <section class="mbr-fullscreen" id="header2-1" style="background-color: #fffde8">
            ...
            <div style="position: absolute; width: 218px; height: 577px; z-index: 1; left: 1293px; top: 86px; background-color: #fffde8" id="layer4" class="style10" >
                <br>
            ...
            <div style="position: absolute; width: 201px; height: 600px; z-index: 1; left: 75px; top: 55px; background-color: #fffde8" id="layer1" class="style10" >
                <br>
            ...
            <div style="position: absolute; width: 592px; height: 405px; z-index: 1; top: 142px; left: 436px" id="layer4 " class="style9">
                <form method="post" action="makegrp?gid=<%=gid%>">
                    <table style="width: 100%; height: 321px">
                        <tr>
                            <td colspan="3" class="style5" style="height: 80px">
                                CREATE GROUP&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="style7" style="width: 556px; height: 79px;">
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <span class="style4">
                                    Choose your 
                                    Group Name</span></td>
                            <td style="height: 79px; width: 36px">
                                <input name="Text1" type="text" required=""></td>
                        ...
                        <tr>
                            <td class="style12" style="width: 556px; height: 79px;">
                                &nbsp;</td>
                            <td style="height: 79px; width: 36px" class="style7">
                                <input name="Submit1" type="submit" value="CREATE"></td>
