...
<html >
    <head>
        ...
        <%
            try {
                ...
                String qry = "select Bio,userpwd, username from tbuser where userid='" + email + "'";
    ...
    <body>
        ...
        <section class="mbr-fullscreen" id="header2-1" style="background-color: #fffde8">
            ...
            <div style="position: absolute; width: 575px; height: 357px; z-index: 1; top: 214px; left: 494px" id="layer4 " class="style9">
            </div>
