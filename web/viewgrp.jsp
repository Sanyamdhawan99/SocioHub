...
&nbsp;&nbsp; <a href="viewblog.jsp?id=<%=gid%>">View available blogs</a></div>
           ...
           <div style="position: relative; width: 768px; z-index: 2; left: 33px; top: 2px; height: 380px;" id="layer7">
               ...
               <table style="width: 100%; height: 309px;">
                        <%
                            try {
                                String qry2 = "select a.username, a.userimg, a.userid from tbuser a, tbgroupmember b where b.memberuserid=a.userid and b.mambergid="+gid;
                        ...
                        <td style="height: 271px">
                            <div class="row">
                                <a href="viewprof2.jsp?id=<%=rs2.getString("a.userid")%>">    <img src="<%=rs2.getString("a.userimg")%>" height="100px" width="100px" style="border-radius: 50%"> </a>
                            </div>
                            <div class="row">
