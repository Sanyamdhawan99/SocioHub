...
<html >
    ...
    <%
        try {
            ...
            String qry = "select username, userimg, ifnull(useradd,'')useradd, ifnull(usermob,'')usermob, ifnull(userqualification,'')userqualification, ifnull(userinterest,'')userinterest, ifnull(Bio,'')Bio, ifnull(userdob,'')userdob from tbuser where userid='" + email + "'";
    ...
    <script>
         function sending(){
                ...
                var url = "reqsend?id=<%=email%>";
                alert(url);
                xmlhttp.onreadystatechange = function(){
                    if(xmlhttp.readyState == 4 && xmlhttp.status == 200){
                        
                      //   if(xmlhttp.responseText == "Friend request sent!") {
                            document.getElementById("isE").style.color = "green";
                            document.getElementById("isE").innerHTML = "Friend request sent!";
                     //   }
        ...
        <section class="mbr-fullscreen" id="header2-1" style="background-color: #fffde8">
            ...
            <div style="position: absolute; width: 709px; height: 506px; z-index: 1; top: 142px; left: 375px" id="layer4 " class="style9">
                    <table style="width: 108%; height: 461px">
                        ...
                        <tr>
                            <td colspan="2" class="style6"><br>
                                <%
                                    String qry2 = "select reqstatus from tbfriend where userid='" + uid + "' and fid='" + email + "'";
                                    ResultSet rs2 = new Global().execute(qry2);
                                    if (rs2.next()) {
                                String st = rs2.getString("reqstatus");
                                    if (st.equals("0")) {
                                %>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        Friend request already sent</td>
                        <%
                        } else if (st.equals("1")) {

                        %>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        You are already friends</td>
                        <%                                }
                                } else {
                                          %>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <button onclick="sending()">SEND FRIEND REQUEST</button>&nbsp;&nbsp;&nbsp;&nbsp;<span id="isE"></span>
