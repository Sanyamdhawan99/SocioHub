...
&nbsp;&nbsp; <a href="viewblog.jsp?id=<%=gid%>">View available blogs</a></div>
            ...
            <div style="position: absolute; width: 40%;  z-index: 1; top: 142px; left: 436px" id="layer4 " class="style9">
                <h2><center>TOPICS</center></h2>  <br><hr>      
                <%
                            try {
                                // gid is fetched
                                String qry2 = "select a.topicid, a.topicdesc, a.topicdate, a.topictime, a.topicuserid, a.topicgid, b.username from tbtopic a, tbuser b where b.userid=a.topicuserid and a.topicgid="+gid;
                        ...
                        <p class="style100">
                                ...
                                <br>
                                 ...
                                 <form name="f1" action="comment?tid=<%=rs2.getString("a.topicid")%>&id=<%=gid%>" method="post" onsubmit="checkmsg();">
                                     <br>
                            ...
                            <br>
                                ...
                                <a href="detail.jsp?tid=<%=rs2.getString("a.topicid")%>&id=<%=gid%>">Click here for detailed view </a>
                                <hr>
                        <%
                            }
                            } catch (Exception e) {
