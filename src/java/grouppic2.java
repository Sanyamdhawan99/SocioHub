 ...
 * @author hp
 */
@WebServlet(urlPatterns = {"/grouppic2"})
public class grouppic2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //out.println("<br>");
            f1.write(f);
            String effpath = "assets/images/"+gid+nm;
            //out.println(effpath);
            //out.println("<br>");
           String qry = "update tbgroup set grpimg='"+effpath+"' where groupid='"+gid+"'";
